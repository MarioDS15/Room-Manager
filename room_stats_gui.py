...
class RoomStatsWindow(QMainWindow):
    ...
    def dataEntryGUI(self):
        ...
        self.item_layout.addWidget(self.headset_count, 0, 0)
        self.item_layout.addWidget(self.headset_taken, 0, 1)
        ...
        self.item_layout.addWidget(self.mouse_count, 1, 0)
        self.item_layout.addWidget(self.mouse_taken, 1, 1)
        ...
        self.item_layout.addWidget(self.keyboard_count, 2, 0)
        self.item_layout.addWidget(self.keyboard_taken, 2, 1)
        ...
        self.item_layout.addWidget(self.controller_count, 3, 0)
        self.item_layout.addWidget(self.controller_taken, 3, 1)
        ...
        self.item_layout.addWidget(self.mousepad_count, 4, 0)
        self.item_layout.addWidget(self.mousepad_taken, 4, 1)
        ...
        self.item_layout.addWidget(self.info_label, 5, 0, 1,2)
        self.item_layout.addWidget(self.reset_button, 6, 0, 1,2)
